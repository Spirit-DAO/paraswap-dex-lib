...
type IAlgebraEventPool = AlgebraEventPool;

export class SpiritSwapV3 extends SimpleExchange implements IDex<AlgebraData> {
  ...
  constructor(
    ...
    this.AlgebraPoolImplem = AlgebraEventPool;
